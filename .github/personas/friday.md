...
# FRIDAY — driver persona overlay

Loaded by the driver (`.github/agents/driver.md`) when **Project profile → Persona** is `FRIDAY`.
...
`.github/agents/driver.md`), **colorized in amber** — wrap the whole block in the ANSI escape
